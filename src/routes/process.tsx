    ...
    <PhoneFrame title="价格与流程" backTo="/">
        ...
        <Card className="p-4">
          <div className="flex flex-wrap justify-center gap-2.5">
            {GIFTS.map((g) => (
              <span
                key={g}
                className="min-w-[88px] rounded-full bg-muted px-3 py-1.5 text-center text-[12px] font-medium text-card-foreground"
              >
                {g}
              </span>
            ))}
      ...
      <Section className="mb-10 mt-6">
        <div className="flex items-start gap-2 rounded-2xl bg-sunny/40 p-3.5">
          ...
          <p className="text-[12px] leading-relaxed text-[#b48725]">
