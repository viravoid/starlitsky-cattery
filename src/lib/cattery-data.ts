...
export const STUDS: Stud[] = [
  ...
  stud("hupo", "琥珀", "棕虎斑麻纹加白 n2509", "现役公猫", "现役公猫", "在役", "骨量足，纹路清晰"),
  stud(
    "shulongyin",
    "水龙吟",
    "黑银鱼骨纹 ns23",
  ...
  stud("tianhe", "天河", "银虎斑加白 ns2203", "现役公猫", "现役公猫", "在役", "大方亲人，表情甜"),
  ...
  stud("yunmu", "云母", "黑银麻纹加白 ns2503", "现役母猫", "现役母猫", "在役", "五官柔和，母性强"),
  stud("niaotuan", "尿团", "银玳瑁虎斑 fs22", "现役母猫", "现役母猫", "在役", "颜色特别，活泼"),
  stud(
    "guihuagao",
    "桂花糕",
    "玳瑁麻纹加白 f2509",
  ...
  stud("zhaoyue", "昭月", "黑银鱼骨纹 ns23", "现役母猫", "现役母猫", "在役", "纹路利落，安静"),
  stud("jingzhe", "惊蛰", "蓝银虎斑 as22", "现役母猫", "现役母猫", "在役", "蓝调稀有，优雅"),
  stud("xiongmao", "小熊猫", "棕麻纹加白 n2509", "现役母猫", "现役母猫", "在役", "圆脸，表情丰富"),
  stud("yunyue", "云玥", "银玳瑁虎斑 fs22", "现役母猫", "现役母猫", "在役", "色块干净，稳重"),
  stud(
    "xiaoxiaxian",
    "小虾线",
    "银玳瑁麻纹 fs25",
  ...
  stud("manao", "玛瑙", "玳瑁虎斑加白 f2209", "现役母猫", "现役母猫", "在役", "加白匀称，甜美"),
  stud("xiaobianmu", "小边牧", "玳瑁虎斑 f22", "现役母猫", "现役母猫", "在役", "花纹俏皮，亲人"),
