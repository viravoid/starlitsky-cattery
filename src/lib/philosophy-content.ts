...
export const DEFAULT_PHILOSOPHY_CONTENT: PhilosophyContent = {
  version: 1,
  openingBelief:
    "我们的繁育理念是繁育体质好，抵抗力强，乖巧亲人大方自信的小猫，从小猫出生开始记录到去新家，让家长不会缺席小猫的每一个阶段，做一家有温度的猫舍。",
  growthEffortParagraph:
    "这些年我们一直在不断努力，投入更多的精力陪伴小猫，从小进行社会化并记录日常，把主粮从 Halo 换成 NG 和百利高。",
  growthCommunityParagraph:
    "这一切的努力都是有回报的，在小猫日常记录群我们也认识了很多新朋友，得到了很多家长的支持与信任，也繁育出了很多很满意的小猫。",
  ...
  styleBloodlineParagraph:
    "如今我们对缅因猫的血线也有了比较深入的了解，意识到血线 / 风格的复杂与多样，不再拘泥于纯美血、纯欧血这种划分。",
  styleBeyondLabelsParagraph: "因为缅因从不只有这两种风格。",
  highlightLineOne: "甜美小体，大体大刷子毛怪，",
  highlightLineTwo: "都代表不了全部的缅因猫。",
  directionGlobalBreedersParagraph:
    "在世界各地都有出色的缅因繁育人，很多繁育人的小猫有着自己独特又有魅力的风格。",
  directionGoalParagraph:
    "我们追求的就是在符合品标的前提下，做好健康筛查，繁育出健康亲人、表情精致甜酷、体格较大、毛量优秀并有自己独特风格的小猫。",
  ...
  closingAftercareParagraph:
    "有任何问题我们都绝不推诿，做好售后，让每个宝宝都能健康长大，和新家长开心生活。",
};
